            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Cambiar Estado del recurso</h4>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-warning m-b-0">
                            <h4><i class="fa fa-info-circle"></i> Cambiar Estado del recurso</h4>
                            <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                        </div>
                    </div>
              <form class="form-horizontal form-bordered" data-parsley-validate="true" 
              name="demo-form" novalidate="" method="POST" action="{{url('/Administracion/estadoDestacadoAdm')}}">  
                    {{ csrf_field() }}
