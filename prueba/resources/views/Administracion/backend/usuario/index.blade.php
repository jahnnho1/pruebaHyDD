 ...
 @section('contentAdm')
    ...
    <h1 class="page-header">Panel administrativo de Productos <small> </small></h1>
					...
					<div class="widget widget-stats bg-green">
						...
						<div class="stats-info">
							<h4>Crear Producto</h4>
                                                        <p>{{$totalProductos}}<small> Productos Agregados </small></p>	
						</div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Productos creados </h4>
                    </div>
                    <div class="alert alert-warning fade in">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        Se han creado un total de <strong>({{$totalProductos}})</strong> Productos
                    </div>
                                ...
                                <tbody>
                                    @forelse($Productos as $pro)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                   <a class="btn btn-icon btn-sm" title="Modificar MP"  href="{{url('/Administracion/modificarProductoAdm')}}/{{$pro->pro_id }}">                                    
                                                    <i class="fa fa-lg fa-edit"> </i>
                                                </a>  
                                                    
                                                <a href="#modal-estado" class="btn btn-icon btn-sm" data-toggle="modal" 
                                                   data-matid="{{$pro->pro_id}}">
            ...
            @include('Administracion.backend.Producto.modalEliminar')
       @include('Administracion.backend.Producto.modalEstado')
