            ...
            <div class="g-bg-white rounded g-pa-50">
              ...
              <form class="g-py-15">
                ...
                <div class="text-center mb-5">
                  <button class="btn btn-block u-btn-primary rounded g-py-13" type="button">Entrar</button>
                </div>
              ...
              <footer class="text-center">
                <p class="g-color-gray-dark-v5 mb-0">No tienes una cuenta? <a class="g-font-weight-600" href="page-signup-8.html">Registrate</a>
                </p>
              </footer>
            </div>
          </div>
